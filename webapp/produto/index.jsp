		...
		<nav class="navbar navbar-expand-lg navbar-dark" id="navbar-especial">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link "
						href="produto/formCadastroProdutos.jsp">Novo Produto</a></li>
				</ul>
			</div>
		</nav>
	</header>
	<main class="container-fluid pt-3">
		<section class="container m-auto p-5" id="menu-produtos">
			<section class="jumbotron jumbotron-fluid mb-2">
				<div class="container">
					<h1 display-4>Produtos</h1>
					<p class="lead">central de registros</p>
				</div>
			</section>
			<section id="pesquisa-produto">
				<nav class="navbar navbar-light bg-light">
					<form action="listaProdutos" method="POST" class="form-inline"
						id="pesquisa-produto">
			...
			<section class="table-responsive" id="lista-produto">
							...
							<tr>
								...
								<td class="text-center">
									<div class="btn-group btn-group-sm" role="group"
										...
										<a href="/gerenciador/exibeProduto?id=${produto.id}"
											type="button" class="btn btn-cor-especial">Editar</a> <a
											href="/gerenciador/removeProduto?id=${produto.id}"
