			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link active"
						href="#">Nova Moto<span class="sr-only">(current)</span></a></li>
				</ul>
			</div>
		</nav>
	</header>
					...
					<div class="form-row">
						...
						<div class="form-group col-md-4">
							<label for="cilindradas">Tamanho (cilindradas)</label> <input
								...
								data-tipo="cilindradas" placeholder="2" required
								name="cilindradaMoto">
							<div class="invalid-feedback">
								Informe uma quantidade válida cilindradas
							</div>
						</div>
					</div>
