					...
					<div class="form-row">
						...
						<div class="form-group col-md-6">
							<label for="pmoto">Placa</label> <input type="text"
								...
								name="placaMoto">
							<div class="invalid-feedback">Informe uma placa válida<small>(Padrão Mercosul: ABC1234)</small></div>
						</div>
					</div>
					...
					<div class="form-row">
						<div class="form-group col-md-4">
							<label for="vmoto">Velocidade Máxima (km/h)</label> <input
								...
								name="velocidadeMoto">
							<div class="invalid-feedback">Informe a velocidade máxima da moto</div>
						</div>
						<div class="form-group col-md-4">
