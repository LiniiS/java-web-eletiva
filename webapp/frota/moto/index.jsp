...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark" id="navbar-especial">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item active"><a class="nav-link" href="#">Motos<span
							class="sr-only">(current)</span></a></li>
					<li class="nav-item"><a class="nav-link "
						href="frota/moto/formCadastroMotos.jsp">Nova Moto</a></li>
				</ul>
			</div>
		</nav>
	</header>
	...
	<main class="container-fluid pt-3">
		<section class="container m-auto p-5" id="menu-motos">
			<section class="jumbotron jumbotron-fluid mb-2">
				<div class="container">
					<h1 display-4>Motos</h1>
			...
			<section id="pesquisa-carros">
				<nav class="navbar navbar-light bg-light">
					<form action="listaMotos" method="POST" class="form-inline"
						id="pesquisa-moto">
			...
			<section class="table-responsive" id="lista-motos">
				...
				<table class="table table-sm mt-3">
					...
					<tbody>
						<c:forEach items="${motos}" var="moto" varStatus="count">
							<tr>
								<th scope="row">${moto.id}</th>
								<td>${moto.marcaVeiculo}</td>
								<td>${moto.placaVeiculo}</td>
								<td>${moto.cilindradaMoto}cc</td>
								<td class="text-center">
									<div class="btn-group btn-group-sm" role="group"
										aria-label="botões em grupo">
										<a href="/gerenciador/exibeMoto?id=${moto.id}" type="button"
											class="btn btn-cor-especial">Editar</a> <a
											href="/gerenciador/removeMoto?id=${moto.id}" type="button"
