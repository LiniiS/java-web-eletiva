...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark" id="navbar-especial">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link"
						href="/gerenciador/frota/moto/formCadastroMotos.jsp">Cadastrar nova Moto</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/gerenciador/listaMotos">Lista de Motos</a></li>
				</ul>
			</div>
		</nav>
	</header>
	...
	<main class="container-fluid pt-3">
		<section class="container m-auto p-5" id="moto-editada">
			...
			<div class="card mb-3 alert alert-dark" style="max-width: 540px;">
				<div class="row no-gutters">
					...
					<div class="col-md-8">
						<div class="card-body">
							<h5 class="card-title">Alterações concluídas!</h5>
							<p class="card-text">
								As alterações foram gravadas com sucesso.
							</p>
							<p class="card-text">
								<small class="text-muted">Dados da moto são e salvos!</small>
							</p>
						</div>
					</div>
				</div>
