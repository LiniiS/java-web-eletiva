...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark" id="navbar-especial">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link"
						href="/gerenciador/formCadastroCarros.jsp">Cadastrar novo
							Carro</a></li>
				</ul>
			</div>
		</nav>
	...
	<main class="container-fluid pt-3">
		<section class="container m-auto" id="lista-carro">
				...
				<tbody>
					<c:forEach items="${carros}" var="carro" varStatus="count">
						<tr>
							...
							<td> ${ carro.velocidadeVeiculo } km/h</td>
						</tr>
				</c:forEach>
				</tbody>
						<% System.out.println(request.getAttribute("carros")); %>
			</table>
