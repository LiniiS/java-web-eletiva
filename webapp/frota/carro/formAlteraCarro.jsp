			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link active"
						href="frota/carro/formCadastroCarros.jsp">Novo Carro<span
	...
	<main class="container-fluid mx-auto">
		<section class="container" id="header-cadastro">
			<section class="jumbotron jumbotron-fluid mb-2">
				<div class="container">
					<h1 display-4>Carro: ${carro.marcaVeiculo}</h1>
					<p class="lead">corrija ou atualize os dados do carro</p>
				</div>
			</section>
			<!--formulários -->
			<section class="container-fluid bg-light pt-2 pb-5 mb-5"
				...
				<form action="alteraCarro" method="POST"
					class="needs-validation" novalidate>
					<div class="form-group col-md-2 mt-2">
						<label class="badge badge-secondary text-wrap text-monospace"
							style="width: 6rem;" for="codigo">Carro id: ${carro.id}</label> <input
							type="text" class="form-control" id="codigo" value="${carro.id}"
							name="id" hidden>
					</div>
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="marca">Marca</label> <input type="text"
								...
								value="${carro.marcaVeiculo }" required name="marcaCarro">
						...
						<div class="form-group col-md-6">
							<label for="pcarro">Placa</label> <input type="text"
								...
								value="${carro.placaVeiculo }" required pattern="[a-zA-Z]{3}[0-9]{4}"
								name="placaCarro">
					...
					<div class="form-row">
						<div class="form-group col-md-4">
							<label for="vcarro">Velocidade Máxima (km/h)</label> <input
								...
								data-tipo="velocidade" value="${carro.velocidadeVeiculo }"required
						...
						<div class="form-group col-md-4">
							<label for="marcha-carro">Marcha</label> <input type="number"
								...
								value="${carro.marchaVeiculo }" required name="marchaCarro">
						...
						<div class="form-group col-md-4">
							<label for="portas"> Quantidade de Portas</label> <input
								...
								pattern="[0-9]{1,2}" value="${carro.portasCarro}" required name="portasCarro">
						...
						<div class="form-group col-md-4">
							<div class="custom-control custom-switch">
								<input type="checkbox" class="custom-control-input" value="${carro.arCarro}"
