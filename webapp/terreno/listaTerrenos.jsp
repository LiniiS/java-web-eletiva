...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark" id="navbar-especial">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link"
						href="/gerenciador/formCadastroTerrenos.jsp">Cadastrar novo
							Terreno</a></li>
				</ul>
			</div>
		</nav>
	...
	<main class="container-fluid pt-3">
		<section class="container m-auto" id="lista-terrenos">
			...
			<table class="table table-sm mt-3">
				...
				<tbody>
					<c:forEach items="${terrenos}" var="terreno" varStatus="count">
						...
						<% System.out.println(request.getAttribute("terrenos")); %>
			</table>
