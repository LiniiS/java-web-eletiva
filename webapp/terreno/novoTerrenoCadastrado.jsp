...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark" id="navbar-especial">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link"
						href="/gerenciador/terreno/formCadastroTerenos.jsp">Cadastrar novo Terreno</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/gerenciador/listaTerrenos">Lista de Terrenos</a></li>
				</ul>
			</div>
		</nav>
	</header>
	...
	<main class="container-fluid pt-3">
		<section class="container m-auto p-5" id="terreno-cadastrado">

			<div class="card mb-3 alert alert-dark" style="max-width: 540px;">
				<div class="row no-gutters">
					<div class="col-md-4">
						<img src="../img/img-cadastro-ok.png" class="img-thumbnail border" alt="Mulher fazendo sinal de OK com os dedos, arte desenhada.">
					</div>
					<div class="col-md-8">
						<div class="card-body">
							...
							<p class="card-text">
								Os dados do terreno foram gravados.
							</p>
							<p class="card-text">
								<small class="text-muted">Dados do terreno são e salvos!</small>
							</p>
						</div>
					</div>
				</div>
