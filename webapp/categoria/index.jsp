		...
		<nav class="navbar navbar-expand-lg navbar-dark" id="navbar-especial">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item active"><a class="nav-link" href="#">Categorias<span
							class="sr-only">(current)</span></a></li>
					<li class="nav-item"><a class="nav-link "
						href="categoria/formCadastroCategorias.jsp">Nova Categoria</a></li>
				</ul>
			</div>
		</nav>
	</header>
	<main class="container-fluid pt-3">
		<section class="container m-auto p-5" id="menu-produtos">
			<section class="jumbotron jumbotron-fluid mb-2">
				<div class="container">
					<h1 display-4>Categorias</h1>
					<p class="lead">central de registros</p>
				</div>
			</section>
			<section id="pesquisa-categoria">
				<nav class="navbar navbar-light bg-light">
					<form action="listaCategorias" method="POST" class="form-inline"
			...
			<section class="table-responsive" id="lista-categoria">
