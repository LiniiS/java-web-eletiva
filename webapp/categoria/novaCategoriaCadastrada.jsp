		...
		<nav class="navbar navbar-expand-lg navbar-dark" id="navbar-especial">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link"
						href="/gerenciador/categoria/formCadastroCategorias.jsp">Cadastrar
							nova Categoria</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/gerenciador/listaCategorias">Lista de Categorias</a></li>
				</ul>
			</div>
		</nav>
	</header>
				...
				<div class="row no-gutters">
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<p class="card-text">
								<small class="text-muted">Nova categoria disponível para seus produtos!</small>
							</p>
						</div>
					</div>
				</div>
