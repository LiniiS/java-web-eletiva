			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item  active"><a class="nav-link"
						href="/gerenciador/formCadastroCategorias.jsp">Alteração de
	...
	<main class="container-fluid mx-auto">
		<section class="container" id="header-cadastro">
			<section class="jumbotron jumbotron-fluid mb-2">
				<div class="container">
					<h1 display-4>Categoria: ${categoria.nome}</h1>
					<p class="lead">corrija ou atualize os dados da Categoria de Produtos</p>
				</div>
			</section>
			<!--formulários -->
			<section class="container-fluid bg-light pt-2 pb-5 mb-5"
				...
				<form action="alteraCategoria" method="POST" class="needs-validation"
					novalidate>
					<div class="form-row">
						<div class="form-group col-md-2 mt-2">
							<label class="badge badge-secondary text-wrap text-monospace"
								style="width: 6rem;" for="codigo">Categoria id:
								${categoria.id}</label> <input type="text" class="form-control"
								id="codigo" value="${categoria.id}" name="id" hidden>
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="nome">Categoria</label> <input type="text"
								...
								name="categoria" required value="${categoria.nome}">
						...
						<div class="form-group col-md-6">
							<label for="codigo">Código</label> <input type="number"
								...
								name="codigo" required value="${categoria.codigoCategoria}">
