...
/**
 * Servlet implementation class NovaMoto apresenta o formulario para cadastro
 * 
 * @author Aline S
 * @version 0.2
 */
...
public class NovaMoto extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// TODO modificar pra usar o sendRedirect
		// resp.sendRedirect("frota/moto/novaMotoCadastrada.jsp");
		// ---------------------------------------> por conflito de path cm o css
		// criou-se
		// ---------------> um novo servlet pra rotear a msg de sucesso e outras
		// navegações
